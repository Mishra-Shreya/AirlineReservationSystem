    ...
    <header id="fh5co-header-section" class="sticky-banner">
      <div class="container">
        <div class="nav-header"><a href="javascript:void(0)" class="js-fh5co-nav-toggle fh5co-nav-toggle dark"><i></i></a>
          <h1 id="fh5co-logo"><a href="index.php">.Traveler.</a></h1>
          <nav id="fh5co-menu-wrap" role="navigation">
            <ul class="sf-menu" id="fh5co-primary-menu">
              <li class="active"><a href="index.php">Airline Reservation system</a></li>
            </ul>
          </nav>
        </div>
      </div>
            ...
            <div class="row">
              ...
              <div class="desc2 animate-box">
                <div class="col-sm-7 col-md-7">
                  ...
                  <h3>Fly to Anywhere</h3>
                  <span class="price">₹1999</span></div>
              </div>
            </div>
          </div>
        </div>
